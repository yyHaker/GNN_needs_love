...
if __name__== "__main__":
	...
	parser.add_argument('--epoch',    	dest="max_epochs",     	default=10000,    type=int,       help='Max epochs')
	...
	# train the model
	model = PyGAT(data.num_features, num_classes, args)
